...
function ProfileScreen() {
  ...
  const Delete = () => {
    Alert.alert(
      '계정 탈퇴',
      "계정 탈퇴 시 회원님이 참여했던 모든 '진행 중인 여행' 및 '공유된 협업 기록'에서 자동으로 제외됩니다.\n\nTravodo를 떠나시겠어요?",
      [
        { text: '취소', style: 'cancel' },
        { text: '확인', onPress: () => console.log('계정 탈퇴 처리') },
      ],
      { cancelable: true },
    );
  };
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.infoBox}>
          ...
          <TouchableOpacity onPress={Delete}>
            <Text style={[styles.link, { marginTop: 24, color: 'crimson' }]}>계정 탈퇴</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
